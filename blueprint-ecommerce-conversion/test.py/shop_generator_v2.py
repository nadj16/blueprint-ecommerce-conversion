...
import os
import json
import google.generativeai as genai  # 🚀 SDK Officiel de Google

# 🔑 TA CLÉ API GEMINI
GEMINI_API_KEY = "AQ.Ab8RN6KbfgpGd-Th5BwpMO-j6db3eyaLr0sdOMRWdZ3bjL5BFw"

# Configuration du SDK Google
genai.configure(api_key=GEMINI_API_KEY)

def appeler_gemini_api(prompt: str) -> str:
    """Parle à Gemini via le SDK officiel"""
...
class CopywriterAgent:
    ...
    async def generate_branding(self, theme: str):
        ...
        # Nettoyage en une seule instruction courte pour éviter les sauts de ligne
...
async def main():
    print("👑 [Jarvis-Manager] Usine IA connectée via le SDK Officiel Google.")
    ...
    print(f"\n🚨 [Jarvis-Manager] Consultation en temps réel de l'IA (Mode SDK Officiel)...")
    try:
